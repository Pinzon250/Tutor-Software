    ...
    <header className="fixed w-screen flex items-center justify-between bg-green-900/50 backdrop-blur-[30px] shadow px-4 py-3 mb-4 z-20">
      <div className="flex items-center space-x-3">
        <button className="lg:hidden" onClick={() => setIsOpen(true)}>
          <Bars3Icon className="h-6 w-6 text-green-600 text-gray-700" />
        </button>
      ...
      <div className="relative ">
          ...
          {menuOpen && (
            <div className="absolute backdrop-blur-[20px] rounded-xl bg-black/40 right-0 mt-2 w-50 mr-70 p-2 mt-4">
              <ul className="m-2">
                <li
